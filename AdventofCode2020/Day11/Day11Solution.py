...
def hey_there_hi_there(seatmap, y_pos, x_pos):
  ...
  possibles = [(y_pos - 1, x_pos - 1), (y_pos - 1, x_pos), (y_pos - 1, x_pos + 1), (y_pos, x_pos + 1), (y_pos + 1, x_pos + 1), (y_pos + 1, x_pos), (y_pos + 1, x_pos - 1), (y_pos, x_pos - 1)]
        ...
        if seatmap[i][j] != None:
          ...
          if seatmap[i][j].occupied == False:
            ...
            for adjacent_seat_pos in seatmap[i][j].neighbors:
              adjacent_seat = seatmap[adjacent_seat_pos[0]][adjacent_seat_pos[1]]
